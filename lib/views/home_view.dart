                          ...
                          child: Column(
                            children: [
                              Expanded(
                                ...
                                child: Row(
                                  children: [
                                    calculateTime(news[index]['publishedAt']),
                                    reduceAuthorSize(news[index]['author'] ?? 'N.A'),
                                  ],
                                ),
                              ),
                              Expanded(
                                flex: 1,
                                child: reduceStringSize(news[index]['title'], 'title')
                              ),
                              Expanded(
                                flex: 1,
                                child: reduceStringSize(news[index]['description'] ?? 'N.A', '')
                              ),
                            ],
                          ),
                        ),
